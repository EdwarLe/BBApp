    ...
    <section class="w-full h-[90%] overflow-hidden pt-3 shadow-lg">
        <section class=" w-full h-full flex flex-col gap-2 items-center justify-start">
            ...
            <div class="flex flex-row-reverse justify-between px-4 w-full">
                <button class="place-self-end mr-2 bg-indigo-800 text-white px-3 py-1 rounded-full transition-colors border border-transparent shadow-md hover:bg-slate-100 hover:text-indigo-800 hover:border-indigo-800" @click="handleShowModal">+ Nuevo Gasto</button>
...
const nameModal = 'Gastos Eventuales'
...
const exportToExcel = () => {
    ...
    XLSX.writeFile(workBook, 'lista_gastos-eventuales.xlsx')
}
